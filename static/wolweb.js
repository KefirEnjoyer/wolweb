...
function renderData() {
    ...
    var gridWidth = "970px";
    gridFields.push({
        name: "connection", title: "ON/OFF", type: "text", width: 120, align: "center",
    ...
    gridFields.push({
        name: "address", title: "IP address ", type: "text", width: 150, validate: { validator: "required", message: "address IP is a required field." }, sorter: function (a, b) {
